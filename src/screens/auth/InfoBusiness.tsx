...
const InfoBusiness: React.FC = () => {
  ...
  try {
    ...
    await userService.updateBusinessInfo(uid, businessData);
    console.log("Informações do negócio salvas");
    navigation.navigate('Home');
  } catch (error) {
    console.error("Erro ao salvar as informações do negócio:", error);
    setCnpjError("Erro ao salvar as informações do negócio");
  } finally {
    setLoading(false);
  }
};
    ...
    <View style={authStyles.container}>
      ...
      <View style={authStyles.containerForm}>
        ...
        <ConfirmButton
          ...
          loading={loading}
          disabled={!estabelecimento || !cnpj || !estado || !cidade}
        />
      </View>
    </View>
  );
